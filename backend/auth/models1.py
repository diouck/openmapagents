"""
auth/models.py — Modèles SQLAlchemy pour users et maps
"""
...
class Map(Base):
    ...
    state_json  = Column(Text, nullable=False)        # JSON complet de la carte
    thumbnail   = Column(Text, default="")            # base64 PNG
